...
<t:formvalid formid="formobj" dialog="false" layout="div" callback="callBack" action="tTitle.do?paramObtain" beforeSubmit="setContentc">
    <fieldset class="step" style="padding-bottom: 20px;">
        ...
        <div class="form">
            ...
            <input type="text" name="tCona0" id="tCona0" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 单价： </label>
            <input type="text" name="tCona1" id="tCona1" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 起订量： </label>
            <input type="text" name="tCona2" id="tCona2" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 供货总量： </label>
            <input type="text" name="tCona3" id="tCona3" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 几天内发货： </label>
            <input type="text" name="tCona4" id="tCona4" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 有效期： </label>
            <input type="text" name="ValidityDate" id="ValidityDate" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
