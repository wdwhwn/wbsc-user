    ...
    <fieldset class="step" style="padding-bottom: 20px;">
        ...
        <table>
            ...
            <%--<tr>
                <td align="center" width="100px"><label class="Validform_label">选择地区:</label></td>
                <td class="value">
                    <t:dictSelect field="id" type="list" extendJson="{class:'form-control input-sm'}"  datatype="n"   dictTable="t_location" dictField="id" dictText="location_name"  hasLabel="false"  title="父类地区"></t:dictSelect>
                        &lt;%&ndash;<t:dictSelect field="webId" type="list" extendJson="{class:'form-control input-sm'}"  datatype="n"   dictTable="t_web" dictField="id" dictText="web_name"  hasLabel="false"  title="网站名称"></t:dictSelect>&ndash;%&gt;
                    <span class="Validform_checktip"></span>
                </td>
            </tr>--%>
           <%-- <tr>
                <td align="center" width="100px"><label class="Validform_label">选择类别:</label></td>
                <td class="value"><t:comboTree url="tTitle.do?getComboTreeData" value="402880e447e99cf10147e9a03b320003" name="categoryId" id="categoryId" width="200"></t:comboTree>
                    <span class="Validform_checktip"></span></td>
            </tr>--%>
            <%--<tr>
                <td align="center" width="100px"><label class="Validform_label">选择类别:</label></td>
                <td class="value">
                    <t:selectZTree id="citySel" url="jeecgFormDemoController.do?getTreeData" windowWidth="400px"></t:selectZTree> <span class="Validform_checktip"></span></td>
            </tr>--%>
            <tr>
                <td align="center" width="100px"><label class="Validform_label">选择类别:</label></td>
                <td class="value">
        ...
        <div class="form">
            ...
            <input type="text" name="hour" id="hour" datatype="*" errormsg="该字段不为空">时
            <input type="text" name="minute" id="minute" datatype="*" errormsg="该字段不为空">分
            <input type="text" name="second" id="second" datatype="*" errormsg="该字段不为空">秒
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
