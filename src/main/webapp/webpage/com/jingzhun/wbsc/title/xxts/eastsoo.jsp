...
<t:formvalid formid="formobj" dialog="false" layout="div" callback="callBack" action="tTitle.do?paramObtain" beforeSubmit="setContentc">
    <fieldset class="step" style="padding-bottom: 20px;">
        ...
        <div class="form">
            ...
            <%--<label > 计量单位： </label>--%>
            <input type="text" name="unit" id="unit"  errormsg="该字段不为空">
            <%--<span class="Validform_checktip"></span>--%>
        </div>
        <div class="form">
            <label class="Validform_label"> 产品单价： </label>
            <input type="text" name="price" id="price"  errormsg="该字段不为空">
            <%--<span class="Validform_checktip"></span>--%>
        </div>
            <div class="form">
                <label class="Validform_label"> 最小订量： </label>
                <input type="text" name="num" id="num"  errormsg="该字段不为空">
                <%--<span class="Validform_checktip"></span>--%>
            </div>
        <div class="form">
            <label class="Validform_label"> 批发价格： </label>
            <input type="text" name="price_w" id="price_w"  errormsg="该字段不为空">
            <%--<span class="Validform_checktip"></span>--%>
        </div>
        <div class="form">
            <label class="Validform_label"> 起批数量： </label>
            <input type="text" name="num_w" id="num_w"  errormsg="该字段不为空">
            <%--<span class="Validform_checktip"></span>--%>
        </div>
        <div class="form">
