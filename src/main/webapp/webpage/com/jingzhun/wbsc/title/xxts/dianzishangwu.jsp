...
<t:formvalid formid="formobj" dialog="false" layout="div" callback="callBack" action="tTitle.do?paramObtain" beforeSubmit="setContentc">
    <fieldset class="step" style="padding-bottom: 20px;">
        ...
        <div class="form">
            ...
            <input type="text" name="post[unit]" id="post[unit]" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 单价： </label>
            <input type="text" name="post[price]" id="post[price]" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 起订数量： </label>
            <input type="text" name="post[minamount]" id="post[minamount]" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 供货总量： </label>
            <input type="text" name="post[amount]" id="post[amount]" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label"> 几天内发货： </label>
            <input type="text" name="post[days]" id="post[days]" datatype="*" errormsg="该字段不为空">
            <span class="Validform_checktip"></span>
        </div>
        <%--<div class="form">
