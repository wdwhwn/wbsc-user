      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            ...
            <h4 class="blue" id="id-company-text">http://www.laitiandq.com/</h4>
          </div>
          ...
          <div class="position-relative">
                  ...
                  <div class="space-6"></div>
                      ...
                      <label class="block clearfix">
                        <div class="input-group">
                          <input type="text" style="width:150px" name="randCode" class="form-control" placeholder="请输入验证码" value="jzrj" id="randCode"/>
            ...
            <div class="center"><h4 class="blue" id="id-company-text">&copy; 文本生成版权所有</h4></div>
