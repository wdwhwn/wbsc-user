...
<body style="overflow-y:hidden;">
	<div class="layout-admin">
		...
		<header class="layout-header">
			<%--<span class="header-logo"><img alt="image" width="190" height="68" src="plug-in/login/images/logo.jpg" /></span>--%>
			<span class="header-logo"><img alt="image" width="190" height="38" src="plug-in/login/images/logo.png" /></span>
			<%--<span class="header-logo"><img alt="image" width="190" height="38" src="plug-in/login/images/logo1.png" /></span>--%>
