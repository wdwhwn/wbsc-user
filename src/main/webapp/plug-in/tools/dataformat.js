...
function listFileImgFormat(value,type){
	...
	var value1 = "imgDDDD/server/"+value;
	// var value1 = value;
	if("image"==type){
         //测试过了
 		href+="<img src='"+value1+"' width=33 height=30  onmouseover='tipImg(this)' onmouseout='moveTipImg()' style='vertical-align:middle'/>";
	}else{
 		if(value.indexOf(".jpg")>-1 || value.indexOf(".gif")>-1 || value.indexOf(".png")>-1){
 			href+="<img src='"+value1+"' onmouseover='tipImg(this)' onmouseout='moveTipImg()' width=30 height=30 style='vertical-align:middle'/>";
 		}else{
 			var value2 = "img2/server/"+value+"?down=true";
